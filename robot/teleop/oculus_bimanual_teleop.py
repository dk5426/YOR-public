...
class OculusReader:
    ...
    def oculus_thread(self):
        ...
        while not self.stop_event.is_set():
            ...
            # print(f"Received controller state: {controller_state}")  # Commented out for performance
    ...
    def control_loop(self):
        ...
        # last_command_timestamp = None
        rate_limiter = RateLimiter(80)  # Limit to 100 Hz
        ...
        while not self.stop_event.is_set():
            ...
            if self.start_teleop_left:
                ...
                # print(f"Setting target pose with preview time: {preview_time:.4f}")  # Commented out for performance
